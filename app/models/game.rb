class Game < ApplicationRecord
    ...
    def update_elo 
        ...
        #home_team = 
        #game.home_team.elo
        home_elo_change = elo_change(self.home_team.elo, self.home_team.elo, self.home_team_score - self.away_team_score)
	    ...
	    #self.home_team.elo += home_elo_change
	    #self.away_team.elo += -home_elo_change
	    #self.save
    end
